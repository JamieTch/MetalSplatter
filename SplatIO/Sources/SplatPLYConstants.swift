struct SplatPLYConstants {
    ...
    enum PropertyName {
        ...
        static let normalX = [ "nx", "normal_x" ]
        static let normalY = [ "ny", "normal_y" ]
        static let normalZ = [ "nz", "normal_z" ]
        ...
        static let albedoR = [ "albedo_r", "base_color_r" ]
        static let albedoG = [ "albedo_g", "base_color_g" ]
        static let albedoB = [ "albedo_b", "base_color_b" ]
